...
const Matrix2D< UAMA, Ring::ObjectType , bool  > UserActionModelPrivate::availableObjectActions = {
   /*                            Person ContactMethod  Call    Media  Certificate   ContactRequest Event, Invididual */
   { UAMA::ACCEPT            , {{ false,    false,     true ,  false,    false,        false,      false,   false   }}},
   { UAMA::HOLD              , {{ false,    false,     true ,  true ,    false,        false,      false,   false   }}},
   { UAMA::MUTE_AUDIO        , {{ false,    false,     true ,  true ,    false,        false,      false,   false   }}},
   { UAMA::MUTE_VIDEO        , {{ false,    false,     true ,  true ,    false,        false,      false,   false   }}},
   { UAMA::SERVER_TRANSFER   , {{ false,    false,     true ,  false,    false,        false,      false,   false   }}},
   { UAMA::RECORD            , {{ false,    false,     true ,  true ,    false,        false,      false,   false   }}},
   { UAMA::HANGUP            , {{ false,    false,     true ,  false,    false,        false,      false,   false   }}},
   { UAMA::JOIN              , {{ false,    false,     true ,  false,    false,        false,      false,   false   }}},
   { UAMA::ADD_NEW           , {{ false,    false,     true ,  false,    false,        false,      false,   false   }}},
   { UAMA::TOGGLE_VIDEO      , {{ false,    false,     true ,  true ,    false,        false,      false,   false   }}},
   { UAMA::ADD_CONTACT       , {{ false,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::ADD_TO_CONTACT    , {{ false,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::DELETE_CONTACT    , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::EMAIL_CONTACT     , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::COPY_CONTACT      , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::BOOKMARK          , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::VIEW_CHAT_HISTORY , {{ false,    false,     false,  false,    false,        false,      false,   false   }}},
   { UAMA::ADD_CONTACT_METHOD, {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::CALL_CONTACT      , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::EDIT_CONTACT      , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::REMOVE_HISTORY    , {{ true ,    true ,     true ,  false,    true ,        false,      false,   true    }}},
   { UAMA::MARK_AS_CONSUMED  , {{ true ,    true ,     true ,  true ,    true ,        false,      false,   true    }}},
};
