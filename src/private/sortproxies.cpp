...
{
   return createModels<ContactSortingCategoryModel>(Session::instance()->contactModel(),(int)Person::Role::Filter, Qt::DisplayRole, [](QSortFilterProxyModel* proxy,const QModelIndex& idx) {
      if (idx.isValid()) {
