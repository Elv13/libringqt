...
QHash<int,QByteArray> CategorizedHistoryModel::roleNames() const
{
   ...
   if (!initRoles) {
      ...
      roles.insert(static_cast<int>(Call::Role::HasVideoRecording) , QByteArray("hasVideoRecording"));
      roles.insert(static_cast<int>(Call::Role::HumanStateName   ) , QByteArray("humanStateName"   ));
      roles.insert(static_cast<int>(Call::Role::IsPresent        ) , QByteArray("isPresent"        ));
      roles.insert(static_cast<int>(Call::Role::LifeCycleState   ) , QByteArray("lifeCycleState"   ));
      roles.insert(static_cast<int>(Call::Role::Missed           ) , QByteArray("missed"           ));
      roles.insert(static_cast<int>(Call::Role::SecurityLevel    ) , QByteArray("securityLevel"    ));
...
HistoryNode* CategorizedHistoryModelPrivate::getCategory(const Call* call)
{
   ...
   if (!category) {
      ...
      Session::instance()->historyModel()->beginInsertRows(QModelIndex(),m_lCategoryCounter.size(),m_lCategoryCounter.size());
      ...
      Session::instance()->historyModel()->endInsertRows();
