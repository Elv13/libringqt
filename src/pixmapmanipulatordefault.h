...
public:
    ...
    QByteArray toByteArray(const QVariant& pxm, const QString& type = QStringLiteral(QStringLiteral("PNG"))) override;
    QVariant   personPhoto(const QByteArray& data, const QString& type = QStringLiteral(QStringLiteral("PNG"))) override;
