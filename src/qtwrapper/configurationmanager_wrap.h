...
Q_SIGNALS: // SIGNALS
    ...
    void knownDevicesChanged(const QString& accountId, const const QMap<QString, QString>& devices);
    ...
    void incomingAccountMessage(const QString& accountId, const QString& from, const const QMap<QString, QString>& payloads);
